...
02_HIGHLIGHTS.txt   (0 KB)
    Five bullet points, each within the 85-character limit.
    Upload as 'Highlights'. Required - the file name must contain the word 'highlights', which it does.

03_COVER_LETTER.txt   (2 KB)
...
figures/   (10 files)
    ...
    Upload each as a separate 'Figure' item, in order.
      ...
      Figure05_SHAP_summary_top3_classes.png           409 KB
      Figure06_model_comparison_heatmap.png            576 KB
      Figure07_malaysia_validation.png                 401 KB
      Figure08_SHAP_waterfall_example.png              265 KB
      Figure09_learning_curve.png                      647 KB
      Figure10_controlled_size.png                     619 KB
