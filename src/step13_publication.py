...
[NOTE ON PUBLICATION CHARGES: with no funding available, prefer a subscription
journal, where publishing is free to the author, over a fully open-access
journal charging an article processing charge of USD 2,000-3,000. Where an
open-access journal is preferred on scientific grounds, apply for the
publisher's low- and middle-income country waiver BEFORE submitting - most
have one, and applying afterwards is harder.]
