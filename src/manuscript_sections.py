...
AUTHORS
    ...
    Sareer Ahmad [1]*, Hooi Ling Lee [2]

AFFILIATIONS

    [1] Department of Chemistry, University of Peshawar, Peshawar 25120,
        Khyber Pakhtunkhwa, Pakistan
    [2] School of Chemical Sciences, Universiti Sains Malaysia,
        11800 USM, Penang, Malaysia

    * Corresponding author. Email: [ADD EMAIL]

ORCID

    Sareer Ahmad    [ADD ORCID - register free at orcid.org, required by ACS]
    Hooi Ling Lee   [ADD ORCID]
...
--------------------------------------------------------------------------------
1. Affiliations above are placeholders drawn from the project brief. Confirm
   the exact departmental wording with each institution.
2. Confirm co-authorship and the author order with Assoc. Prof. Dr. Lee Hooi
   Ling before submitting. Listing a supervisor without their agreement is a
   serious breach of publication ethics.
3. ORCID identifiers are mandatory for the corresponding author at ACS and are
   strongly encouraged by most other publishers.
"""
