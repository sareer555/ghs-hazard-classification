...
# MANUSCRIPT TITLE
# ---------------------------------------------------------------------------
# Kept here, in one place, because the title page and the cover letter are
# generated by different scripts. Each used to hold its own wording, and they
# drifted apart: the cover letter announced a manuscript by a title that did
# not match the one on the title page. Format with the cleaned compound count.
MANUSCRIPT_TITLE_TEMPLATE = (
    "Interpretable Machine Learning for Predicting GHS Chemical Hazard "
    "Classifications: A Multi-Label Approach Using {n_compounds:,} Compounds "
    "and Scaffold-Based Validation")


def manuscript_title(n_compounds):
